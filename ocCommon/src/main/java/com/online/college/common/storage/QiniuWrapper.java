...
public class QiniuWrapper {
	...
	private static final String CONFIG_BUCKET="ocbucket";
	
	private static final String CONFIG_AK="9nyvLAhtPg7HROzht6UzERaJlz4boTZFODUhKUMC";
	private static final String CONFIG_SK="Rr1Fuoc8hEmORki2DPwfig6WP-dIB_6K2sbLFcxP";
	private static final String CONFIG_CDN="pnizooe2c.bkt.clouddn.com";
