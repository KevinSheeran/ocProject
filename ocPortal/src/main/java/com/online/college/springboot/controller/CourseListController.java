...
public class CourseListController {
     ...
     * @return
     */
    @RequestMapping("/actionCourseList")
    public ModelAndView actionCourseList(String c, String sort, TailPage<Course> page){
        ModelAndView mv = new ModelAndView("actionCourseList");
        String curCode = "-1";//当前方向code
        String curSubCode = "-2";//当前分类code
    ...
    public ModelAndView freeCourseList(String c, String sort, TailPage<Course> page){
        ModelAndView mv = new ModelAndView("freeCourseList");
        String curCode = "-1";//当前方向code
        String curSubCode = "-2";//当前分类code
